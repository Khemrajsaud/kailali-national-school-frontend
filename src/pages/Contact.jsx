...
import { Mail, MapPin, Phone, Send, Clock, ChevronRight } from "lucide-react";
    ...
    <div style={{ background: "var(--bg)", color: "var(--text)" }}>
      ...
      <section className="relative h-64 sm:h-80 w-full overflow-hidden flex items-center">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(10,31,51,0.85) 0%, rgba(16,42,67,0.7) 100%)",
          }}
        />
        <div
          ...
          <motion.div {...fadeInUp} className="lg:col-span-5 space-y-8">
            <div>
              ...
              <p className="text-[--text-sec] leading-relaxed text-[15px]">
                Whether you want to apply for enrollment, arrange a physical
                school tour, or ask about curriculum plans, our office team is
                standing by to help.
              </p>
            </div>
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(37,99,235,0.04) 0%, rgba(10,31,51,0.02) 100%)",
            ...
            >
              ...
              <div>
                <span
                  className="font-bold block text-[--navy] mb-1"
                  style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
                >
                  Office Working Hours
                </span>
                <span>
                  Sunday – Friday: 9:00 AM – 4:00 PM (Closed on Saturdays and
                  public holidays).
                </span>
              </div>
            </div>
            ...
            <form ref={form} onSubmit={sendEmail} className="space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    name="name"
                    placeholder={
                      t.contact?.form?.placeholderName || "e.g. John Doe"
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    name="email"
                    placeholder={
                      t.contact?.form?.placeholderEmail ||
                      "e.g. name@domain.com"
                    }
                    className="w-full px-4 py-3 rounded-xl border border-[--border] bg-[--bg-alt] text-sm text-[--text] focus:outline-none focus:border-[--blue] focus:ring-2 focus:ring-blue-100 transition-all duration-200"
                    required
              ...
              <div>
                ...
                <input
                  ...
                  name="subject"
                  placeholder={
                    t.contact?.form?.placeholderSubject || "How can we help?"
                  }
                  className="w-full px-4 py-3 rounded-xl border border-[--border] bg-[--bg-alt] text-sm text-[--text] focus:outline-none focus:border-[--blue] focus:ring-2 focus:ring-blue-100 transition-all duration-200"
                  required
                />
...
<section className="w-full rounded-3xl overflow-hidden ">
  <div className="w-full aspect-[16/9] min-h-[350px] max-h-[500px]">
    <iframe
      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3501.935088358732!2d81.1442866!3d28.6317075!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39a2133dadf31a3f%3A0xe1ad6e8ca9f00426!2sKailali%20National%20Academy!5e0!3m2!1sen!2snp!4v1786100292489!5m2!1sen!2snp"
      className="w-full h-full border-0 block"
      allowFullScreen
      loading="eager"
      referrerPolicy="strict-origin-when-cross-origin"
      title="Kailali National Academy Map Location"
    />
  </div>
</section>
