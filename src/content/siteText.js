const en = {
  ...
  nav: {
    ...
    download: "downloads",
    brandTitle: "kailali national school",
  ...
  footer: {
    ...
    address: "Kailali, Sudurpaschim Province, Nepal",
    phone: "+977-91-540488",
    email: "contact@kailalinational.edu.np",
    copyright: "© 2024 kailali national school. All rights reserved.",
  ...
  home: {
    hero: {
      title: "Welcome to kailali national school",
...
It is with great pride and joy that I welcome you to kailali national school. As an institution dedicated to excellence in education, we stand committed to nurturing not just academic brilliance, but also strong character, critical thinking, and compassionate citizenship.

At kailali national school, we believe that every child is unique, with their own talents, interests, and potential. Our mission is to create an environment where these individual strengths can flourish, where curiosity is encouraged, and where students are inspired to dream big and work hard to achieve their goals.
...
It is with great pleasure and pride that I welcome you to kailali national school. As the Chairman of this esteemed institution, I am honored to be part of a community dedicated to shaping future leaders, thinkers, and innovators.

At kailali national school, we believe that education is not just about academic excellence but about holistic development. Our mission is to nurture young minds, instill strong values, and provide an environment where every child can discover their unique potential and thrive.
